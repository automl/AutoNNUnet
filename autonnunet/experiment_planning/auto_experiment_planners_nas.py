...
from dynamic_network_architectures.building_blocks.helper import convert_dim_to_conv_op, get_matching_instancenorm, get_matching_batchnorm, get_matching_dropout, convert_conv_op_to_dim
...
class AutoExperimentPlanner(ExperimentPlanner):
    ...
    def get_plans_for_configuration(
        ...
        if self.hp_config.normalization == "InstanceNorm":
            ...
            raise ValueError(f"Normalization {self.hp_config.normalization} not supported.")
        ...
        if self.hp_config.activation == "ReLU":
            ...
            raise ValueError(f"Activation function {self.hp_config.activation} not supported.")
...
class nnUNetPlannerResEncM(AutoResEncUNetPlanner):
    ...
    def __init__(self, 
        ...
        super().__init__(hp_config, dataset_name_or_id, gpu_memory_target_in_gb, preprocessor_name, plans_name,
